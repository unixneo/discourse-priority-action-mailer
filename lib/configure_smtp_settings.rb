...
smtp_address_mentions = defined?(GlobalSetting.smtp_address_mentions) ? GlobalSetting.smtp_address_digest : GlobalSetting.smtp_address
smtp_port_mentions = defined?(GlobalSetting.smtp_port_mentions) ? GlobalSetting.smtp_port_digest : GlobalSetting.smtp_port
smtp_user_name_mentions = defined?(GlobalSetting.smtp_user_name_mentions) ? GlobalSetting.smtp_user_name_digest : GlobalSetting.smtp_user_name
smtp_password_mentions = defined?(GlobalSetting.smtp_password_mentions) ? GlobalSetting.smtp_password_digest : GlobalSetting.smtp_password
smtp_authentication_mentions = defined?(GlobalSetting.smtp_authentication_mentions) ? GlobalSetting.smtp_authentication_digest : GlobalSetting.smtp_authentication
smtp_enable_start_tls_mentions = defined?(GlobalSetting.smtp_enable_start_tls_mentions) ? GlobalSetting.smtp_enable_start_tls_digest : GlobalSetting.smtp_enable_start_tls
